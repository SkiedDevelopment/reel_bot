...
async def addaccount(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await log_to_group(context.bot, f"<pre>{traceback.format_exc()}</pre>")
...
async def submit(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    async with AsyncSessionLocal() as s:
        ...
        if row:
            ...
            if rem>0:
                ...
                asyncio.create_task(asyncio.sleep(5) and
    ...
    try:
        ...
        return await update.message.reply_text("⚠️ Can’t fetch reel.")
