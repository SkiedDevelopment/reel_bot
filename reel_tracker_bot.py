...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "/addaccount <tg_id> @insta — assign account (admin)\n"
        "/removeaccount <tg_id> @insta — remove account (admin)\n"
        "/userstats <tg_id> — stats for a user (admin)\n"
        "/submit <Reel URL> — submit a reel\n"
        "/stats — your stats\n"
        "/remove <Reel URL> — untrack a reel\n"
        "Admin only:\n"
...
# ... implement other commands similarly, ensuring admin-only where needed ...
